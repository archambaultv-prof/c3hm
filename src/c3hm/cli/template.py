...
@click.option(
    ...
    type=int,
    default=None,
    help="Indique la taille de l'équipe."
)
...
@click.option(
    ...
    type=int,
    multiple=True,
    help=("Liste des nombres d'indicateurs par critère "
          "(ex: -c 8 -c 5 pour 2 critères avec 8 et 5 indicateurs)")
)
def template_command(output_path: Path,
    ...
    export_template(output_path, nb_levels=nb_levels,
                    team_size=team_size,
                    criteria_indicators=indicators_list)
